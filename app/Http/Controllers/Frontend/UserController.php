...
class UserController extends Controller
{
    ...
    public function profile($id)
    {
        ...
        return view("frontend.$module_name.profile", compact('sumpay','module_name', 'module_name_singular', "$module_name_singular", 'module_icon', 'module_action', 'module_title', 'body_class', 'userprofile', 'meta_page_type'));
    }

                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <?php echo app('translator')->get("service::text.name"); ?>
                            </th>
                            <th class="text-end">
                                <?php echo app('translator')->get("service::text.action"); ?>
                            </th>
                        </tr>
                    </thead>
                </table>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\caratamir\Modules/Service/Resources/views/backend/services/index_datatable.blade.php ENDPATH**/ ?>
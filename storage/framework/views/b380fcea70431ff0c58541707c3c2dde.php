<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="">
            <img class="" height="50px" src="<?php echo e(asset('img/default-banner.jpg')); ?>" alt="<?php echo e(app_name()); ?>">
        </a>
        ...
        <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav ms-auto">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('frontend.users.profile', ['id' => encode_id(auth()->user()->id)])); ?>"
                            class="nav-link">
                            داشبرد
                        </a>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_backend')): ?>
                    <li class="nav-item">
                        <a href='<?php echo e(route('backend.dashboard')); ?>' class="nav-link" role="menuitem">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('frontend.users.profileEdit', encode_id(auth()->user()->id))); ?>" class="nav-link"
                            role="menuitem">
...
<?php /**PATH C:\xampp\htdocs\caratamir\resources\views/frontend/includes/header.blade.php ENDPATH**/ ?>
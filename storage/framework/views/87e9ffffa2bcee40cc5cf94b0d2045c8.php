...
<?php foreach($attributes->onlyProps(["route"=>"", "icon"=>"fas fa-plus-circle", "title", "small"=>"", "class"=>""]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\caratamir\resources\views/components/buttons/create.blade.php ENDPATH**/ ?>
        ...
        <div class="row">
            <div class="col-sm-3 py-4">
                <div class="p-4 shadow-lg">
                    ...
                    <p class="">
                        جهت ثبت سفارش خدمت رسانی فرم زیر را تکمیل کنید
                    </p>
            ...
            <div class="col-sm-9 py-4">
                <div class="shadow-lg p-4">
                    <h2>درخواست خدمت رسان</h2>
                    <form class="rtl" method="POST" action="{{ route('frontend.customer.orders.store') }}" class="">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" id="mobile" name="mobile" type="text" placeholder="">
                            </div>
                            <div class="col-sm-6">

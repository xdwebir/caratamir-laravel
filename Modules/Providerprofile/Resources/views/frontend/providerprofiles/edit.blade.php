        ...
        <div class="row">
            <div class="col-sm-3 py-4">
                <div class="p-4 shadow-lg">
                    <h3 class="">پروفایل خدمات</h3>
                    <p class="">
                        جهت دریافت سفارشات لازم است فرم روبرو را تکمیل کنید
                    </p>
            ...
            <div class="col-sm-9 py-4">
                <div class="p-4 shadow-lg">
                    ...
                    @if ($profile != null)
                        <div class="">
                            <div class="row">
                                <h3>اطلاعات پروفایل خدمت رسانی شما</h3>
                                <div class="col-sm-4">استان: {{ $profile->state_name }}</div>
                                <div class="col-sm-4">شهر: {{ $profile->city_name }}</div>
                                <div class="col-sm-4">خدمت: {{ $profile->servicename }}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">شروع کاری: {{ $profile->start_time }}</div>
                                <div class="col-sm-4">پایان کاری: {{ $profile->end_time }}</div>
                            </div>
                        </div>
                        <hr>
                    @endif
                    ...
                    <form class="rtl" method="POST"
                        action="{{ route('frontend.providerprofiles.update', ['id' => auth()->user()->id]) }}"
                        class="">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="relative">
                                    <select class="form-control" id="state_id" name="state_id"
                                        onChange="CityList(this.value);document.getElementById('state_name').value = this.options[this.selectedIndex].text;">
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-6">
                                <label for="start_time" class="form-label">شروع کار:</label>
                                <input type="time" name="start_time" id="start_time" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                                <label for="end_time" class="form-label">پایان کار:</label>

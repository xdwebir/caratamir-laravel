                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("providerprofile::text.name")
                            </th>
                            <th>
                                @lang("providerprofile::text.slug")
                            </th>
                            <th>
                                @lang("providerprofile::text.updated_at")
                            </th>
                            <th>
                                @lang("providerprofile::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("providerprofile::text.action")
                            </th>
                        </tr>
                    </thead>

...
use App\Http\Controllers\AuthSMS\AuthenticatedSessionController;
use App\Http\Controllers\AuthSMS\NewPasswordController;
use App\Http\Controllers\AuthSMS\PasswordResetLinkController;
use App\Http\Controllers\AuthSMS\RegisteredUserController;
...
Route::middleware('guest')->group(function () {
    ...
    Route::post('login', [\App\Http\Controllers\AuthSMS\AuthenticatedSessionController::class, 'store'])
    ->name('login.store');
...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::group(['middleware' => ['auth','can:view_frontend_customer']], function () {
        /*
        *
    ...
    Route::group(['middleware' => ['auth','can:view_frontend_operator']], function () {
        /*
        *
